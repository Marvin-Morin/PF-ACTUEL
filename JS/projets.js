...
const modale_wordpress_imts = document.querySelector('.modale.wordpress_imts');
...
document.querySelector('#wordpress-institut_marie_therese_solacroup').addEventListener('click', () => openModal(modale_wordpress_imts));
